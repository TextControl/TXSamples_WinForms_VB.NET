...
Namespace TXTextControl.Words
    Partial Class MainWindow
        ...
        ' Manages the layout of the left sidebar if its ContentLayout is set to TrackedChanges or DocumentSettings. 
        '-----------------------------------------------------------------------------------------------------------
        ...
        '-----------------------------------------------------------------------------------------------------------
        Private Sub SidebarRight_PropertyChanged(ByVal sender As Object, ByVal e As System.ComponentModel.PropertyChangedEventArgs)
