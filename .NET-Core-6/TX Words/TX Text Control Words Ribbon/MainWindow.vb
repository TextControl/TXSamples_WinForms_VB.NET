...
Namespace TXTextControl.Words
    Partial Public Class MainWindow
        ...
        Private Sub SetAppMenuDesign()
            ...
            SetRibbonButtonDesign(ResourceProvider.FileMenuItem.TXITEM_DocumentSettings.ToString(), m_rtbtnDocumentSettings)
            SetRibbonButtonDesign(ResourceProvider.FileMenuItem.TXITEM_About.ToString(), Me.m_rtbtnAbout, My.Resources.AboutButton_ToolTip_Description)
            SetRibbonButtonDesign(ResourceProvider.FileMenuItem.TXITEM_Exit.ToString(), m_rbtnExit)
        ...
        Private Sub SetAppMenuBehavior()
            ...
            ' Document Settings:
            AddHandler m_rtbtnDocumentSettings.CheckedChanged, AddressOf DocumentSettings_CheckedChanged ' Hide/show sidebar when button is toggled        		

            ' About:
            AddHandler m_rtbtnAbout.CheckedChanged, AddressOf Me.About_CheckedChanged

            ' Exit:
            AddHandler m_rbtnExit.Click, AddressOf Exit_Click
