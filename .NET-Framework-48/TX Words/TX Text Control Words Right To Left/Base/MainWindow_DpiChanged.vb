            ...
            Select Case m.Msg
                ...
                Case &H2E0 ' WM_DPICHANGED
                    ...
                    If m_fDPI <> CSharpImpl.Assign(m_fDPI, iNewDPI) Then
                        ...
                        m_rgAppViewGroup.SmallIcon = CSharpImpl.Assign(m_rbtnRightToLeft.SmallIcon, bmpSmallIcon)

                        ' Update the large icon.
                        Dim bmpLargeIcon = GetLargeIcon("RightToLeft_Large.svg")
                        m_rgAppViewGroup.LargeIcon = CSharpImpl.Assign(m_rbtnRightToLeft.LargeIcon, bmpLargeIcon)
                    End If
            End Select
            MyBase.WndProc(m)
        End Sub
