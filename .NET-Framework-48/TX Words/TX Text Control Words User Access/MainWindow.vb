...
Namespace TXTextControl.Words
    Partial Public Class MainWindow
        ...
        Protected Overrides Sub OnLoad(ByVal e As EventArgs)
            ...
            Open(m_strFilesDirectory & "Protected Document.tx", StreamType.InternalUnicodeFormat)
        ...
        Private Sub SetAppMenuDesign()
            ...
            SetRibbonButtonDesign(ResourceProvider.FileMenuItem.TXITEM_SignIn.ToString(), m_rbtnSignIn, m_strUserName)
            SetRibbonButtonDesign(ResourceProvider.FileMenuItem.TXITEM_CurrentUser.ToString(), m_rmbtnCurrentUser, m_strUserName)
            SetRibbonButtonDesign(ResourceProvider.FileMenuItem.TXITEM_AccountSettings.ToString(), m_rbtnAccountSettings, m_strUserName)
            SetRibbonButtonDesign(ResourceProvider.FileMenuItem.TXITEM_SignOut.ToString(), m_rbtnSignOut, m_strUserName)
        ...
        Private Sub SetAppMenuBehavior()
            ...
            ' Sign In:
            AddHandler m_rbtnSignIn.Click, AddressOf SignIn_Click

            ' [Current User]:
            AddHandler m_rbtnAccountSettings.Click, AddressOf AccountSettings_Click ' Account Settings (Drop Down Button)
            AddHandler m_rbtnSignOut.Click, AddressOf SignOut_Click ' Sign Out (Drop Down Button)
